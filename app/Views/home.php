                ...
                <?php foreach ($menuItems as $item): ?>
                    <div class="col-12 col-md-6 mb-3">
                        <?php if (!empty($item['modal'])): ?>
                            <a href="#" class="menu-card card p-4 h-100" data-bs-toggle="modal" data-bs-target="#loginModal" style="text-decoration: none;">
                            <?php else: ?>
                                <a href="<?= $item['link'] ?>" class="menu-card card p-4 h-100" style="text-decoration: none;">
                                <?php endif ?>
